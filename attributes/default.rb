...
default[:polyglot][:android][:home] = ::File.join(node[:jenkins][:node][:home],'/tools/android-sdk-linux')
...
default[:polyglot][:ruby][:gems] = [ 'aws-sdk', 'berkshelf', 'capistrano', 'bundler' ]
default[:polyglot][:ruby][:gem_cache] = "#{node[:jenkins][:node][:home]}/gem-cache"
default[:polyglot][:ruby][:gem_opts] = '--no-ri --no-rdoc'
default[:polyglot][:ruby][:gem_sources] = []
override[:rbenv][:rubies] = [ '2.0.0-p0', 'jruby-1.7.3' ]
